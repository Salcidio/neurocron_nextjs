    ...
    extend: {
      ...
      keyframes: {
        ...
        "neon-pulse": {
          ...
          "50%": {
            "box-shadow":
              "0 0 10px rgb(6 182 212), 0 0 20px rgb(6 182 212), 0 0 30px rgb(6 182 212)",
      ...
      backgroundImage: {
        ...
        "blue-pink-gradient-br":
          "linear-gradient(to bottom right, #3b82f6, #ec4899)", // Bottom-right blue to pink
      },
      ...
      boxShadow: {
        ...
        "neon-glow":
          "0 0 30px rgb(168 85 247 / 0.3), 0 0 60px rgb(6 182 212 / 0.3)",
        // Adjusted for blue/pink
        "blue-glow":
          "0 0 30px rgb(59 130 246 / 0.3), 0 0 60px rgb(236 72 153 / 0.3)",
      },
    },
  },
  plugins: [],
