...
export default function ChatPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex">
      ...
      {/* Animated background */}
      <div className="absolute inset-0 bg-gradient-to-br from-green-900/20 to-teal-900/20 -z-10"></div>
      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <header className="relative z-20 w-full bg-black/50 backdrop-blur-sm p-4 flex items-center justify-end">
          ...
          <button
            onClick={clearChat}
            className="p-3 bg-gradient-to-r from-green-600 to-teal-600 rounded-lg text-white font-medium hover:shadow-lg hover:shadow-green-500/25 transform hover:scale-105 transition-all duration-200 border border-green-400/50"
            aria-label="Clear Chat"
          >
            <Trash2 size={22} /> {/* Replaced text with icon */}
          </button>
        </header>
